...
<head>
    ...
    <title>Gange-Galskap: Treningsutgave</title>
    <style>
        :root {
            --bg: #0f172a;
            --card: #1e293b;
...
<div class="container">
    ...
    <div id="game-screen" class="hidden">
        ...
        <input type="number" id="ans-input" autocomplete="off" autofocus>
...
<script>
    ...
    ansInp.addEventListener('keydown', (e) => {
        // Vi teller tastetrykk som forsøk på å svare
    ...
    function finish() {
        ...
        ana.innerHTML = "<b style='color:var(--accent)'>Oppgaver å øve mer på:</b><br><br>";
